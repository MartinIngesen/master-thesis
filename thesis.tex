...
\input{sub/DAIMData} % this is the file which contains all the details about your thesis
...
\include{sub/relatedwork}
\include{sub/background}
\include{sub/methodology}
\include{sub/experiment}
\include{sub/resultsanalysis}
\include{sub/discussion}
\include{sub/conclusion}
% ======== INSERT STUFF HERE ^^^ ========

\iffalse
\include{inc/02042020}
\include{inc/introduction} % includes latex files from the same directory
\include{inc/literaturereview}
